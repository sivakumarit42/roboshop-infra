parameters = [
  { name = "prod.frontend.catalogue_url", value = "http://catalogue-prod.devopsb72.online:80/", type = "String" },
  { name = "prod.frontend.user_url", value = "http://user-prod.devopsb72.online:80/", type = "String" },
  { name = "prod.frontend.cart_url", value = "http://cart-prod.devopsb72.online:80/", type = "String" },
  { name = "prod.frontend.shipping_url", value = "http://shipping-prod.devopsb72.online:80/", type = "String" },
  { name = "prod.frontend.payment_url", value = "http://payment-prod.devopsb72.online:80/", type = "String" },
  { name = "prod.user.mongo", value = "true", type = "String" },
  { name = "prod.user.redis_host", value = "redis-prod.devopsb72.online", type = "String" },
  { name = "prod.user.mongo_url", value = "mongodb://mongodb-prod.devopsb72.online:27017/catalogue", type = "String" },
  { name = "prod.shipping.cart_endpoint", value = "cart-prod.devopsb72.online:80", type = "String" },
  { name = "prod.shipping.db_host", value = "mysql-prod.devopsb72.online", type = "String" },
  { name = "prod.payment.cart_host", value = "cart-prod.devopsb72.online", type = "String" },
  { name = "prod.payment.cart_port", value = "80", type = "String" },
  { name = "prod.payment.user_host", value = "user-prod.devopsb72.online", type = "String" },
  { name = "prod.payment.user_port", value = "80", type = "String" },
  { name = "prod.payment.amqp_host", value = "rabbitmq-prod.devopsb72.online", type = "String" },
