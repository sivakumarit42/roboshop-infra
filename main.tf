...
module "elasticache" {
  source = "git::https://github.com/sivakumarit42/tf-modue-elasticache.git"
  env    = var.env
  tags   = var.tags
...
module "app" {
  ...
  depends_on = [module.vpc, module.docdb, module.docdb, module.rds, module.elasticache, module.alb, module.rabbitmq]
